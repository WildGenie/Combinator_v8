...
[peaks,locs] = findpeaks(plotSpectrum,'MinPeakHeight',0.01);
...
complex_voigt(wavenum(idcs), wavenumSim(simIndex(i)),gaussianFWHMsim(simIndex(i)),lorentzianFWHMsim(simIndex(i)))
fun = @(params,x) complex_voigt(x,params(1),params(2),params(3));
...
fun = @(wavenum,amp,pWavenumAxis,vipaGaussianFWHM,vipaLorentzianFWHM) makeMolecularSpectrum(polyval(pWavenumAxis,wavenum),wavenumSim,concentration*intCrossSectionSim,gaussianFWHMsim+vipaGaussianFWHM,lorentzianFWHMsim+vipaLorentzianFWHM);
