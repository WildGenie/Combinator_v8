function returnData = public_acquireMultipleBackgroundSpectra( self, numImages)
...
%   Detailed explanation goes here
    ...
    % Get the input
        ...
        % Aquire images
        self.dependencyHandles.MOD_ExternalAcquireSync.acquireBackgroundImages(3);

        if size( self.dependencyHandles.MOD_FLIRcamera.collectedImageArray,1) ~= self.fringeImageSize(1) ||...
                size(self.dependencyHandles.MOD_FLIRcamera.collectedImageArray,2) ~= self.fringeImageSize(1)
