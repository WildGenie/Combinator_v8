function [returnSpectra,returnImages,returnSpectrumIndcs] = acquirePhotolysisSpectra( self, numImages)
...
%   Detailed explanation goes here
    ...
    % Get the input
        ...
        % Aquire images
        returnImages = self.dependencyHandles.MOD_ExternalAcquireSync.acquirePhotolysisImages(numImages);
