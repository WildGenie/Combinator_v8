...
classdef PropertyGridField < hgsetget
    properties
        ...
        ValueChangeCallback = @(name,oldValue,newValue) PropertyGridPackage.NOP;
        % Parent PropertyGrid Object
        Parent;
    ...
    methods
        function self = PropertyGridField(name, value, varargin)
            self.Name = name;
            self.Value = value;
            self = PropertyGridPackage.constructor(self, varargin{:});
        end
        ...
        function self = set.ValueChangeCallback(self, callback_handle)
            validateattributes(callback_handle, {'function_handle'}, {'nonempty'});
            self.ValueChangeCallback = callback_handle;
        end
